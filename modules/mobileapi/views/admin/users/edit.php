<div class="one_full">
    <section class="title">
        <h4><?php echo lang('mobileapi:edit_user') ?></h4>
    </section>

    <section class="item">
        <div class="content">
            <?php echo form_open(site_url('admin/mobileapi/edit/'.$user_id)); ?>
            <fieldset>
                <ul>
                    <li>
                        <label for="title"><?php echo lang('mobileapi:user_name') ?> <span>*</span></label>
                        <div class="input"><?php echo form_input('user_name', $user->name, 'maxlength="100" id="user_name"') ?></div>
                    </li>
